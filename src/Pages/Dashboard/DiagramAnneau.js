...
function DiagramAnneau({ beneficiaires, peyroll }) {
    ...
    datasets: [
      {
        ...
        backgroundColor: ['#29C3FC', '#7F3A7F', '#FD0D0D', '#A93226', '#1223F7', '#3DB84E', '#337357', '#FFC300'],
      },
    ],
  };
  ...
  return (
    ...
    <Card className='card-graph' style={{ width: '100%', maxWidth: '100%', borderRadius: '12px', padding:'20px',top: '13px', height: '69.5%' }}> 
      <Pie 
        data={data} 
        options={options} 
        style={{ 
