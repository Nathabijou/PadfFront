...
const menuItems = [
  ...
  { key: '/App/dashboard', label: 'Dashboards', icon: <DashboardOutlined /> },
  { key: '/App/Report', label: 'Reports', icon: <DashboardOutlined /> },
  { key: '/App/globaldashboard', label:'new ', icon: <DashboardOutlined />},
  { key: '/projectcomponent/petitprojet/beneficiaire/${petitprojet.id}', label: 'Bénéficiaires', icon: <UserOutlined /> },
  ...
  { key: 'https://docs.google.com/spreadsheets/d/1YJ0xW0mNbZdZ_9HXgN4V_qEQzTBl9Y_U_s51PGx6mkI/edit#gid=197995468', label: 'Suivi des Jalons', icon: <InfoCircleOutlined /> },
