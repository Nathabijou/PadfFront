...
export default function AddPetitProjet() {
    ...
    const{nom,description,type,Rangdepriorisation,datedebut,datefin,nmbreFilledirect,nmbreGarcondirect, nmbreBeneficiaireIndirect
    ...
    const onSubmit=async(e)=>{
        ...
        e.preventDefault();
        await axios.post("http://localhost:8080/petitprojet", petitprojet)
        ...
        <div className="Container">
            <div className="row">
                <div className="col-md-6 offset-md-3 border rounded p-4 mt-2 shadow">
                      <h2 className="text-center m-4 ">Enregister un Petit Projet</h2>
